...
import '../view_models/learning_path_view_model.dart';
      ...
      body: Stack(
        children: [
          ...
          SafeArea(
            ...
            child: ListenableBuilder(
              ...
              builder: (context, _) {
                ...
                if (viewModel.errorMessage != null && viewModel.tracks.isEmpty) {
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () => viewModel.loadTracks(),
                                  ...
                                  child: Column(
                                    children: [
                                      TrackNodeWidget(
                                        track: tracks[0],
                                        horizontalOffset: -48,
                                        onTap: () => context.push('/track/${tracks[0].id}'),
                                        onSubCategoryTap: (subId) => context.push('/track/${tracks[0].id}/$subId'),
                                      ),
                                      const SizedBox(height: 24),
                                      TrackNodeWidget(
                                        track: tracks[1],
                                        horizontalOffset: 48,
                                        onTap: () => context.push('/track/${tracks[1].id}'),
                                        onSubCategoryTap: (subId) => context.push('/track/${tracks[1].id}/$subId'),
                                      ),
                                      const SizedBox(height: 24),
                                      TrackNodeWidget(
                                        track: tracks[2],
                                        horizontalOffset: -48,
                                        onTap: () => context.push('/track/${tracks[2].id}'),
                                        onSubCategoryTap: (subId) => context.push('/track/${tracks[2].id}/$subId'),
                                      ),
                                      const SizedBox(height: 24),
                                      TrackNodeWidget(
                                        track: tracks[3],
                                        horizontalOffset: 32,
                                        onTap: () => context.push('/track/${tracks[3].id}'),
                                        onSubCategoryTap: (subId) => context.push('/track/${tracks[3].id}/$subId'),
                                      ),
                                      const SizedBox(height: 24),
                                      TrackNodeWidget(
                                        track: tracks[4],
                                        horizontalOffset: -64,
                                        onTap: () => context.push('/track/${tracks[4].id}'),
                                        onSubCategoryTap: (subId) => context.push('/track/${tracks[4].id}/$subId'),
                                      ),
                                      const SizedBox(height: 36),
                                      TrackNodeWidget(
                                        track: tracks[5],
                                        horizontalOffset: 0,
                                        onTap: () => context.push('/track/${tracks[5].id}'),
                                        onSubCategoryTap: (subId) => context.push('/track/${tracks[5].id}/$subId'),
                                      ),
                                    ],
                                  ),
                                ),
          ...
          Positioned(
            ...
            left: 0,
            right: 0,
            child: _buildHeader(context, l10n.start),
          ),
        ],
      ),
    );
