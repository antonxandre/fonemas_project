...
import '../../../../core/widgets/miki_bottom_nav_bar.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
                          ...
                          child: Column(
                            children: [
                              ...
                              _buildSubPathNode(
                                ...
                                horizontalOffset: -48,
                                onTap: () => context.go('/exercise/${widget.trackId}'),
                              ),
                              const SizedBox(height: 24),
          ...
          // 4. Floating Glassmorphism Bottom Navigation Bar
          Positioned(
            bottom: 0,
            left: 0,
            right: 0,
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: MikiColors.primary.withValues(alpha: 0.1),
                    width: 1.0,
                    style: BorderStyle.values[1], // dashed mock
                  ),
                ),
              ),
            ),
