...
class StudyPage extends StatelessWidget {
              ...
              builder: (context, state) {
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () => context.read<StudyCubit>().loadBooks(),
                ...
                if (state is StudyLoaded) {
                  ...
                  return RefreshIndicator(
                    onRefresh: () => context.read<StudyCubit>().loadBooks(),
                    color: MikiColors.primary,
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Explore histórias e aprenda brincando.',
  ...
  Widget _buildFeaturedBookCard(BuildContext context, Book book) {
    return GestureDetector(
      onTap: () => context.go('/study/read/${book.id}'),
      child: Container(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () => context.go('/study/read/${book.id}'),
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(
                ...
                width: 1.5,
                style: BorderStyle.values[1], // Mock dashed borders
              ),
            ),
            child: const Center(
              child: Column(
