...
class MinimalPairsStrategy implements ExerciseStrategy {
  ...
  Widget buildWidget({
    ...
    if (hasImages) {
      if (count == 4) {
        // 2x2 Grid (like desafio_4_animais_code.html)
        ...
        // Horizontal Row (like cards_minimalistas_miki_code.html)
        optionsLayout = Row(
  ...
  // Build Card containing image and label
